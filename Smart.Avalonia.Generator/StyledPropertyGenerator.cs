...
using Smart.Avalonia.Generator.Models;
...
{
    private const string AttributeName = "Smart.Avalonia.StyledPropertyAttribute";
    ...
    private static List<string> MakeOptionArguments(string className, PropertyModel property)
    {
        ...
        {
            arguments.Add($"validate: static value => {property.Validate.MethodName}(value)");
        }
